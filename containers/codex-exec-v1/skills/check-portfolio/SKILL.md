...
description: "Read the codex-exec-v1 portfolio configuration file verbatim. Use when the user asks to check, show, load, or reference the configured portfolio, portfolio tickers, holding list, or portfolio file."
---
...
3. `/workspace/containers/codex-exec-v1/config/portfolio.txt`.
4. `containers/codex-exec-v1/config/portfolio.txt` when running from a local repository checkout.
