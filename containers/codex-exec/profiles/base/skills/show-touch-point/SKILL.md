...
description: "Render price-trigger alert touch points on the configured indicator candlestick chart as Telegram-ready PNG images. Use when the user asks for /show-touch-point {trigger_id}, /show_touch_point {trigger_id}, or $show-touch-point with a price trigger id such as kospi-case-1."
---
