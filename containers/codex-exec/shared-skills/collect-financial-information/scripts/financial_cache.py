...
def command_self_test(args: argparse.Namespace) -> int:
    ...
    test_path = Path(__file__).resolve().parents[1] / "tests" / "test_financial_cache.py"
    spec = importlib.util.spec_from_file_location("financial_cache_self_test", test_path)
