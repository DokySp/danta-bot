...
DAILY_TRADING_STAGE_MODEL_CONTRACT = (
    ...
    "- first-verdict sub-agent: model=gpt-5.4-mini, effort=medium, selected 4 analysts only "
    "(analyst-blackrock, analyst-fidelity, analyst-jpmorgan, analyst-morganstanley).\n"
    "- second-verdict sub-agent: model=gpt-5.5, effort=low, judge-midterm only with at most 2 retries.\n"
