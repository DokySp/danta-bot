...
DAILY_TRADING_STAGE_MODEL_CONTRACT = (
    ...
    "the pipeline `execution-plan` as a non-submitting gate summary; if it reports candidates ready for Main-agent "
    "submission, open only the minimal required order/account artifacts and `trade-execution.md` gates needed to "
    "submit or block those candidates. Do not reread verdict inputs or rebuild scoring just to submit orders.\n"
