    ...
    for run_index, run in enumerate(runs):
        ...
        for analyst_item in analyst_symbols:
            ...
            symbol_buttons.append(
                f'<button type="button" class="trade-symbol-button{" active" if is_active_symbol else ""}" data-symbol-target="{esc(composite_key)}">'
