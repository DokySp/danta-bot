...
class DailyTradingDirectRunner:
    ...
    def pipeline_script(self) -> Path:
        candidates = [
            ...
            / "containers/codex-exec/shared-skills/daily-trading/scripts/run_daily_trading_pipeline.py",
            Path("/app/skills/daily-trading/scripts/run_daily_trading_pipeline.py"),
        ]
