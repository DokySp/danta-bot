...
$ export CODEX_EXEC_V1_VERSION=1.1.2
...
$ docker save -o "./containers/*images/codex-exec-v1-$CODEX_EXEC_V1_VERSION.tar" codex-exec-v1:$CODEX_EXEC_V1_VERSION
...
$ docker tag codex-exec-v1:$CODEX_EXEC_V1_VERSION $DOCKERHUB_NAMESPACE/codex-exec-v1:$CODEX_EXEC_V1_VERSION
...
$ docker push $DOCKERHUB_NAMESPACE/codex-exec-v1:$CODEX_EXEC_V1_VERSION
...
$ docker pull $DOCKERHUB_NAMESPACE/codex-exec-v1:$CODEX_EXEC_V1_VERSION
...
`telegram-gateway`, `kis-trade-mcp`, `codex-exec-v1`은 분리해서 실행합니다. 각 compose는 공용 네트워크 `danta-bot-net`을 사용하므로 최초 1회 네트워크를 먼저 만듭니다.
